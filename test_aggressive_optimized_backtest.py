...
def main():
    ...
    config = EnhancedBacktestConfig(
        ...
        # 优化版参数
        max_position_size=0.25,  # 单只股票最大仓位25%
        min_position_size=0.03,  # 最小仓位3%
        ...
        bull_market_multiplier=2.0,  # 牛市仓位倍数
        bear_market_multiplier=0.7,  # 熊市仓位倍数
        max_daily_loss=0.06  # 最大日损失6%
    )
    ...
    results_file = f"结果/aggressive_optimized_backtest_results_{timestamp}.json"
